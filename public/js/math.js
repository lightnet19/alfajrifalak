...
function hijriToJD(hy, hm, hd) {
  // FIX: Jangan kurangi hy-1 / hm-1 — itu menyebabkan error 384 hari!
  // Formula benar: JD = floor((11N+3)/30) + 354N + 30M - floor((M-1)/2) + D + 1948440 - 385
...
// ── Alias untuk kompatibilitas antar modul ──
// hilal.js, ui.js, dan modul lain boleh pakai nama mana saja
const jdH = jdToHijri;   // JD → Hijri date
const hJ  = hijriToJD;   // Hijri date → JD
const jdG_alias = jdG;   // sudah ada di math.js
